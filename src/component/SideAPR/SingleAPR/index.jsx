...
import { Container, Title, Wrapper1, Wrapper2, Wrapper3 } from './style'
import { InputNumberStyled } from '../PairAPR/style';
...
export const SignleAPR = () => {
  return (
    <Container>
      <Title>Single- side APR</Title>
      <Wrapper1>
